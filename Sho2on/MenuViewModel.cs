...
namespace HR_Application
{
    public class MenuViewModel : INotifyPropertyChanged
    {
        ...
        private async Task LoadMenuDataAsync()
        {
            ...
            {
                LocalizationManager.ShowMessage($"Œÿ√ ›Ì  Õ„Ì· »Ì«‰«  «·ﬁ«∆„…: {ex.Message}", "Œÿ√", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async Task LoadMenuStructureAsync()
        {
            var menus = _context.Menus
                .Include(m => m.Children) //  Õ„Ì· «·√ÿ›«· »‘ﬂ· ’—ÌÕ
            ...
            var rootMenus = menuLookup[null].ToList(); // «·ﬁÊ«∆„ «·—∆Ì”Ì… (ParentId = null)
