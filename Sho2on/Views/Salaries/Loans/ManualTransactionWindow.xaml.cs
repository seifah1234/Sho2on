...
namespace HR_Application.Views
{
    public partial class ManualTransactionWindow : Window
    {
        ...
        public ManualTransactionWindow(string transactionType)
        {
            ...
            Title = transactionType == "Deposit" ? LocalizationManager.Translate("إضافة إيداع يدوي") : LocalizationManager.Translate("إضافة سحب يدوي");
            InitializeComponent();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text = _transactionType == "Deposit" ? LocalizationManager.Translate("إضافة إيداع يدوي لصندوق الزمالة") : LocalizationManager.Translate("إضافة سحب يدوي من صندوق الزمالة"),
                FontSize = 14,
            ...
            {
                Content = LocalizationManager.Translate("المبلغ:"),
                Width = 80,
                VerticalAlignment = VerticalAlignment.Center
            };
            ...
            {
                Content = LocalizationManager.Translate("الوصف:"),
                Width = 80,
                VerticalAlignment = VerticalAlignment.Center
            };
            ...
            {
                Content = LocalizationManager.Translate("ملاحظات:")
            };
            ...
            {
                Content = LocalizationManager.Translate("حفظ"),
                Width = 100,
                Height = 35,
        ...
        private async Task SaveTransaction()
        {
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("الرجاء إدخال مبلغ صحيح", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
                    return;
                }

                if (string.IsNullOrWhiteSpace(txtDescription.Text))
                {
                    LocalizationManager.ShowMessage("الرجاء إدخال وصف للعملية", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
                    return;
                }
                ...
                if (_transactionType == "Withdrawal")
                {
                    ...
                    if (amount > balance)
                    {
                        LocalizationManager.ShowMessage($"رصيد الصندوق غير كافي. الرصيد المتاح: {balance:N2}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
                        return;
                    }
                }
                ...
                LocalizationManager.ShowMessage("تم حفظ الحركة بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
