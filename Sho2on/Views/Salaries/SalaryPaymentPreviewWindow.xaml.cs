...
namespace HR_Application.Views
{
    public partial class SalaryPaymentPreviewWindow : Window
    {
        ...
        private void InitializeComponent()
        {
            ...
            var columns = new[]
            {
                new DataGridTextColumn { Header = "الكود", Binding = new System.Windows.Data.Binding("Code"), Width = 80 },
                new DataGridTextColumn { Header = "الاسم", Binding = new System.Windows.Data.Binding("Name"), Width = 150 },
                new DataGridTextColumn { Header = "الفرع", Binding = new System.Windows.Data.Binding("Branch"), Width = 100 },
                new DataGridTextColumn { Header = "الراتب الأساسي", Binding = new System.Windows.Data.Binding("BasicSalary") { StringFormat = "N2" }, Width = 100 },
                new DataGridTextColumn { Header = "الإضافات", Binding = new System.Windows.Data.Binding("Additions") { StringFormat = "N2" }, Width = 100 },
                new DataGridTextColumn { Header = "الاستقطاعات", Binding = new System.Windows.Data.Binding("Deductions") { StringFormat = "N2" }, Width = 100 },
                new DataGridTextColumn { Header = "صندوق الزمالة", Binding = new System.Windows.Data.Binding("FriendshipBoxAmount") { StringFormat = "N2" }, Width = 100 },
                new DataGridTextColumn { Header = "السلف", Binding = new System.Windows.Data.Binding("LoanDeduction") { StringFormat = "N2" }, Width = 80 },
                new DataGridTextColumn { Header = "الصافي", Binding = new System.Windows.Data.Binding("NetSalary") { StringFormat = "N2" }, Width = 100 }
            };
        ...
        private void BtnPrint_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (printDialog.ShowDialog() == true)
                {
                    ...
                    printDialog.PrintDocument(((IDocumentPaginatorSource)document).DocumentPaginator, "معاينة صرف المرتبات");
                }
            }
            catch (Exception ex)
            {
        ...
        private FlowDocument CreatePrintDocument()
        {
            ...
            string[] headers = { "الكود", "الاسم", "الفرع", "الراتب الأساسي", "الإضافات", "الاستقطاعات", "صندوق الزمالة", "السلف", "الصافي" };
            ...
            summary.Inlines.Add(new Run("ملخص الإجماليات:")
            {
                FontWeight = FontWeights.Bold,
                FontSize = 14
            });
