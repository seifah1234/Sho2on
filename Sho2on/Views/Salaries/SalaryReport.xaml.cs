    ...
    public partial class SalaryReport : Window
    {
        ...
        private async Task GetDataSalary()
        {
            ...
            catch (Exception ex)
            {
                await Dispatcher.InvokeAsync(() =>
                {
                    LocalizationManager.ShowMessage($"خطأ في تحميل البيانات: {ex.Message}",
        ...
        private async void data_load_btn_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                data_load_btn.Content = LocalizationManager.Translate("جاري التحميل...");
            ...
            finally
            {
                ...
                data_load_btn.Content = LocalizationManager.Translate("تحميل البيانات");
            }
        }
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    using (var workbook = new XLWorkbook())
                    {
                        ...
                        var headers = new[]
                        {
                            LocalizationManager.Translate("الكود"), LocalizationManager.Translate("الاسم"), LocalizationManager.Translate("الفرع"), LocalizationManager.Translate("الوظيفة"), LocalizationManager.Translate("الراتب"), LocalizationManager.Translate("بدل سكن"), LocalizationManager.Translate("بدل انتقال"),
                            LocalizationManager.Translate("بدل ادارة"), LocalizationManager.Translate("بدل طبيعة عمل"), LocalizationManager.Translate("اضافي"), LocalizationManager.Translate("مكافآت"), LocalizationManager.Translate("عمولات تحقيق"), LocalizationManager.Translate("عمولات خارجية"), LocalizationManager.Translate("اجمالي الاستحقاقات"),
                            LocalizationManager.Translate("الغياب"), LocalizationManager.Translate("التأخير"), LocalizationManager.Translate("سلف"), LocalizationManager.Translate("جزاء"), LocalizationManager.Translate("ضريبة"), LocalizationManager.Translate("تأمين"), LocalizationManager.Translate("صندوق الزمالة"),
                            LocalizationManager.Translate("مشاركة اجتماعي"), LocalizationManager.Translate("اجمالي الاستقطاعات"), LocalizationManager.Translate("الاجمالي")
                        };
                ...
                {
                    LocalizationManager.ShowMessage(e.Message, LocalizationManager.Translate("خطأ"));
                }
            }
        }
        ...
        public FlowDocument CreateDocument(List<SalaryClass> records, string year, string month)
        {
            ...
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("الاسم"), true, false));
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("الفرع"), true, false));
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("الوظيفة"), true, false));
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("الراتب"), true, false));
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("اجمالي الاستحقاقات"), true, false));
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("اجمالي الاستقطاعات"), true, false));
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("صافي الراتب"), true, false));
        ...
        private static Table CreateEmployeeTable(SalaryClass employee)
        {
            ...
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("الاسم:"), true, 1));
            headerRow.Cells.Add(CreateCell(employee.Name, false, 3));
            table.RowGroups[0].Rows.Add(headerRow);

            headerRow = new TableRow();
            headerRow.Cells.Add(CreateCell(LocalizationManager.Translate("الكود:"), true, 1));
            headerRow.Cells.Add(CreateCell(employee.Code, false, 3));
            table.RowGroups[0].Rows.Add(headerRow);

            // Section Headers
            var sectionHeaderRow = new TableRow();
            sectionHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("الاستحقاقات"), true, 2));
            sectionHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("الاستقطاعات"), true, 2));
            ...
            // Salary Details
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("المرتب:"), employee.Salary, LocalizationManager.Translate("ض كسب عمل:"), employee.Tax));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("بدل سكن:"), employee.Houseing, LocalizationManager.Translate("تأمينات الموظف:"), employee.Insurance));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("بدل ادارة:"), employee.Depart, LocalizationManager.Translate("مشاركة اجتماعية:"), employee.Social));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("بدل طبيعة عمل:"), employee.Nature, LocalizationManager.Translate("ص الزمالة:"), employee.Box));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("بدل انتقال:"), employee.Transmission, LocalizationManager.Translate("جزاء:"), employee.Penalty));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("اضافي:"), AllOT, LocalizationManager.Translate("سلف:"), employee.Ancestor));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("قيمة اضافي:"), employee.Added, LocalizationManager.Translate("عجز:"), employee.Deficit));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("مكافآت:"), employee.Reward, LocalizationManager.Translate("الغياب:"), Abcense.ToString()));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("عمولات تحقيق"), employee.TargetCommission, LocalizationManager.Translate("قيمة الغياب:"), employee.Abcence));
            table.RowGroups[0].Rows.Add(CreateDataRow(LocalizationManager.Translate("عمولات خارجية"), employee.ExternalCommission, LocalizationManager.Translate("التأخير:"), AllLate));
            table.RowGroups[0].Rows.Add(CreateDataRow("", "", LocalizationManager.Translate("قيمة التأخير:"), employee.Late));
            table.RowGroups[0].Rows.Add(CreateDataRow("", "", LocalizationManager.Translate("تأمين الشركة:"), employee.CompanyInsurance));
            table.RowGroups[0].Rows.Add(CreateDataRow("", "", LocalizationManager.Translate("اذونات:"), employee.Permission));
            table.RowGroups[0].Rows.Add(CreateDataRow("", "", LocalizationManager.Translate("فاتورة تليقون:"), employee.Phone));

            // Final Salary Row
            var totalRow = new TableRow();
            totalRow.Cells.Add(CreateCell(LocalizationManager.Translate("صافي الراتب:"), true, 2));
