    ...
    public partial class SalaryReport : Window
    {
        ...
        private async Task GetDataSalary()
        {
            ...
            catch (Exception ex)
            {
                await Dispatcher.InvokeAsync(() =>
                {
                    LocalizationManager.ShowMessage($"Œÿ√ ›Ì  Õ„Ì· «·»Ì«‰« : {ex.Message}",
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    using (var workbook = new XLWorkbook())
                    {
                        ...
                        {
                            "«·ﬂÊœ", "«·«”„", "«·›—⁄", "«·ÊŸÌ›…", "«·—« »", "»œ· ”ﬂ‰", "»œ· «‰ ﬁ«·",
                            "»œ· «œ«—…", "»œ· ÿ»Ì⁄… ⁄„·", "«÷«›Ì", "„ﬂ«›¬ ", "⁄„Ê·«   ÕﬁÌﬁ", "⁄„Ê·«  Œ«—ÃÌ…", "«Ã„«·Ì «·«” Õﬁ«ﬁ« ",
                            "«·€Ì«»", "«· √ŒÌ—", "”·›", "Ã“«¡", "÷—Ì»…", " √„Ì‰", "’‰œÊﬁ «·“„«·…",
                            "„‘«—ﬂ… «Ã „«⁄Ì", "«Ã„«·Ì «·«” ﬁÿ«⁄« ", "«·«Ã„«·Ì"
                        };
                ...
                {
                    LocalizationManager.ShowMessage(e.Message, "Œÿ√");
                }
            }
        }
        ...
        public FlowDocument CreateDocument(List<SalaryClass> records, string year, string month)
        {
            ...
            var cell6 = CreateCell($"’«›Ì „— »«  ‘Â— : {month} - {year}", false, true);
            cell6.FontSize = 14;
            ...
            var titleParagraph = new System.Windows.Documents.Paragraph(new System.Windows.Documents.Run($" ﬁ—Ì— „— »«   ›’Ì·Ì"))
            {
            ...
            headerRow.Cells.Add(CreateCell("«·›—⁄", true, false));
            headerRow.Cells.Add(CreateCell("«·ÊŸÌ›…", true, false));
            headerRow.Cells.Add(CreateCell("«·—« »", true, false));
            headerRow.Cells.Add(CreateCell("«Ã„«·Ì «·«” Õﬁ«ﬁ« ", true, false));
            headerRow.Cells.Add(CreateCell("«Ã„«·Ì «·«” ﬁÿ«⁄« ", true, false));
            headerRow.Cells.Add(CreateCell("’«›Ì «·—« »", true, false));
        ...
        private static Table CreateEmployeeTable(SalaryClass employee)
        {
            ...
            headerRow.Cells.Add(CreateCell("«·«”„:", true, 1));
            headerRow.Cells.Add(CreateCell(employee.Name, false, 3));
            table.RowGroups[0].Rows.Add(headerRow);

            headerRow = new TableRow();
            headerRow.Cells.Add(CreateCell("«·ﬂÊœ:", true, 1));
            headerRow.Cells.Add(CreateCell(employee.Code, false, 3));
            table.RowGroups[0].Rows.Add(headerRow);

            // Section Headers
            var sectionHeaderRow = new TableRow();
            sectionHeaderRow.Cells.Add(CreateCell("«·«” Õﬁ«ﬁ« ", true, 2));
            sectionHeaderRow.Cells.Add(CreateCell("«·«” ﬁÿ«⁄« ", true, 2));
            ...
            // Salary Details
            table.RowGroups[0].Rows.Add(CreateDataRow("«·„— »:", employee.Salary, "÷ ﬂ”» ⁄„·:", employee.Tax));
            table.RowGroups[0].Rows.Add(CreateDataRow("»œ· ”ﬂ‰:", employee.Houseing, " √„Ì‰«  «·„ÊŸ›:", employee.Insurance));
            table.RowGroups[0].Rows.Add(CreateDataRow("»œ· «œ«—…:", employee.Depart, "„‘«—ﬂ… «Ã „«⁄Ì…:", employee.Social));
            table.RowGroups[0].Rows.Add(CreateDataRow("»œ· ÿ»Ì⁄… ⁄„·:", employee.Nature, "’ «·“„«·…:", employee.Box));
            table.RowGroups[0].Rows.Add(CreateDataRow("»œ· «‰ ﬁ«·:", employee.Transmission, "Ã“«¡:", employee.Penalty));
            table.RowGroups[0].Rows.Add(CreateDataRow("«÷«›Ì:", AllOT, "”·›:", employee.Ancestor));
            table.RowGroups[0].Rows.Add(CreateDataRow("ﬁÌ„… «÷«›Ì:", employee.Added, "⁄Ã“:", employee.Deficit));
            table.RowGroups[0].Rows.Add(CreateDataRow("„ﬂ«›¬ :", employee.Reward, "«·€Ì«»:", Abcense.ToString()));
            table.RowGroups[0].Rows.Add(CreateDataRow("⁄„Ê·«   ÕﬁÌﬁ", employee.TargetCommission, "ﬁÌ„… «·€Ì«»:", employee.Abcence));
            table.RowGroups[0].Rows.Add(CreateDataRow("⁄„Ê·«  Œ«—ÃÌ…", employee.ExternalCommission, "«· √ŒÌ—:", AllLate));
            table.RowGroups[0].Rows.Add(CreateDataRow("", "", "ﬁÌ„… «· √ŒÌ—:", employee.Late));
            table.RowGroups[0].Rows.Add(CreateDataRow("", "", " √„Ì‰ «·‘—ﬂ…:", employee.CompanyInsurance));
            table.RowGroups[0].Rows.Add(CreateDataRow("", "", "«–Ê‰« :", employee.Permission));
            table.RowGroups[0].Rows.Add(CreateDataRow("", "", "›« Ê—…  ·ÌﬁÊ‰:", employee.Phone));

            // Final Salary Row
            var totalRow = new TableRow();
            totalRow.Cells.Add(CreateCell("’«›Ì «·—« »:", true, 2));
