...
namespace HR_Application
{
    ...
    public partial class ErrandsWindow : Window
    {
            ...
            try
                {
                    try
                    {
                        ...
                        LocalizationManager.ShowMessage("تم اضافة الاجراء");
                    }
                    catch (Exception ex)
                    {
            ...
            if (_selectedEmployee != null)
            {
                try
                {
                        ...
                        var procedure = new Procedure
                            ...
                            LocalizationManager.ShowMessage("تم تقديم الطلب");
                        }
                        catch (Exception ex)
                        {
                            LocalizationManager.ShowMessage($"Error: {ex.Message}");
        ...
        private void btnSelectApprover_Click(object sender, RoutedEventArgs e)
        {
            ...
            var managerSelectionWindow = new EmployeeSelectionWindow(_managers, true, LocalizationManager.Translate("اختر الموافق على المأمورية"));
