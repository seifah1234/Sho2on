...
namespace HR_Application.Views
{
    ...
    public partial class BenefitsDeductions : Window
    {
        ...
        {
            _operations.Add(0, LocalizationManager.Translate("استقطاعات"));
            _operations.Add(1, LocalizationManager.Translate("استحقاقات"));

            _types.Add(11, LocalizationManager.Translate("مكافأة"));
            _types.Add(10, LocalizationManager.Translate("جزاء"));
            _types.Add(9, LocalizationManager.Translate("سلفة"));
            _types.Add(16, LocalizationManager.Translate("عجز"));

            _types.Add(1, LocalizationManager.Translate("المرتب"));
            _types.Add(2, LocalizationManager.Translate("بدل سكن"));
            _types.Add(3, LocalizationManager.Translate("بدل انتقال"));
            _types.Add(4, LocalizationManager.Translate("تأمينات الموظف"));

            _types.Add(5, LocalizationManager.Translate("ض. كسب عمل"));
            _types.Add(6, LocalizationManager.Translate("مشاركة اجتماعية"));
            _types.Add(12, LocalizationManager.Translate("غياب"));
            _types.Add(13, LocalizationManager.Translate("صندوق الزمالة"));

            _types.Add(14, LocalizationManager.Translate("بدل إدارة"));
            _types.Add(15, LocalizationManager.Translate("بدل طبيعة عمل"));

            _types.Add(18, LocalizationManager.Translate("عمولات تحقيق"));
            _types.Add(19, LocalizationManager.Translate("عمولات خارجية"));
            _types.Add(20, LocalizationManager.Translate("فاتورة تليفون"));
        ...
        private async void delete_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                MessageBoxResult result = LocalizationManager.ShowMessage("هل تريد حذف هذا السجل؟", LocalizationManager.Translate("تأكيد الحذف"),
                ...
                if (result == MessageBoxResult.Yes)
                {
                    ...
                    if (salaryOperation != null)
                    {
                        ...
                        LocalizationManager.ShowMessage("تم حذف السجل بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
                        await GetDataAsync();
                    }
                }
            }
        ...
        private async Task GetDataAsync()
        {
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("يرجى إدخال كود الموظف و اختيار الفرع", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }

                if (!int.TryParse(code_box.Text, out int employeeCode))
                {
                    LocalizationManager.ShowMessage("كود الموظف يجب أن يكون رقماً", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
                ...
                if (employee == null)
                {
                    LocalizationManager.ShowMessage("الموظف غير موجود أو ليس لديك صلاحية الوصول", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
        ...
        private void excel_btn_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("لا توجد بيانات لتصديرها", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
                ...
                worksheet.Name = LocalizationManager.Translate("الاستقطاعات والاستحقاقات");

                // إضافة العناوين إلى مستند Excel
                worksheet.Cells[1, 1] = LocalizationManager.Translate("رقم السجل");
                worksheet.Cells[1, 2] = LocalizationManager.Translate("القيمة");
                worksheet.Cells[1, 3] = LocalizationManager.Translate("النص");
                worksheet.Cells[1, 4] = LocalizationManager.Translate("العملية");
                worksheet.Cells[1, 5] = LocalizationManager.Translate("النوع");
                worksheet.Cells[1, 6] = LocalizationManager.Translate("التاريخ");
                ...
                LocalizationManager.ShowMessage($"تم تصدير البيانات بنجاح إلى: {filePath}", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
        ...
        private void add_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("يرجى إدخال كود الموظف أولاً", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
