    ...
    public partial class BulkSalaryPaymentWindow : Window
    {
        ...
        private async Task CalculateEmployeeSalary(EmployeeSalaryViewModel viewModel, User user)
        {
            try
            {
                ...
                viewModel.PaymentStatus = existingPayment?.IsPaid == true ? LocalizationManager.Translate("تم الصرف") : LocalizationManager.Translate("لم يصرف");
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في حساب راتب الموظف {user.FullName}: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void BtnPaySelected_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("الرجاء تحديد موظفين لصرف رواتبهم", LocalizationManager.Translate("تنبيه"), MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            var result = LocalizationManager.ShowMessage(
                ...
                LocalizationManager.Translate("تأكيد الصرف"),
            ...
            if (result == MessageBoxResult.Yes)
            {
                try
                {
                    ...
                    LocalizationManager.ShowMessage($"تم صرف رواتب {selectedEmployees.Count} موظف بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
                ...
                {
                    LocalizationManager.ShowMessage($"خطأ في صرف الرواتب: {ex.InnerException}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
        }
        ...
        private async Task ProcessSalaryPayment(EmployeeSalaryViewModel emp)
        {
            ...
            var salaryPayment = new SalaryPayment
            {
                ...
                Notes = LocalizationManager.Translate("صرف جماعي"),
            ...
            emp.PaymentStatus = LocalizationManager.Translate("تم الصرف");
        ...
        private void BtnPreview_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!selectedEmployees.Any())
            {
                LocalizationManager.ShowMessage("الرجاء تحديد موظفين للمعاينة", LocalizationManager.Translate("تنبيه"), MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
