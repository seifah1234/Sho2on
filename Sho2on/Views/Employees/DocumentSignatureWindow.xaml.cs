...
namespace HR_Application.Views
{
    public partial class DocumentSignatureWindow : Window
    {
        ...
        private async void signBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «·„·› «·„Êﬁ⁄", " Õ–Ì—",
            ...
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("«·ÊÀÌﬁ… €Ì— „ÊÃÊœ…", "Œÿ√",
                        MessageBoxButton.OK, MessageBoxImage.Error);
                    return;
                }
                ...
                LocalizationManager.ShowMessage($" „  ÊﬁÌ⁄ «·ÊÀÌﬁ… »‰Ã«Õ ÊÕ›ŸÂ« ›Ì:\n{destinationPath}", "‰Ã«Õ",
            ...
            {
                LocalizationManager.ShowMessage($"Œÿ√ ›Ì  ÊﬁÌ⁄ «·ÊÀÌﬁ…: {ex.Message}", "Œÿ√",
                    MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
