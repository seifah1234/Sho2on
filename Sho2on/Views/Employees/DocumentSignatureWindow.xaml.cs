...
namespace HR_Application.Views
{
    public partial class DocumentSignatureWindow : Window
    {
        ...
        private async void signBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار الملف الموقع", LocalizationManager.Translate("تحذير"),
            ...
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("الوثيقة غير موجودة", LocalizationManager.Translate("خطأ"),
                        MessageBoxButton.OK, MessageBoxImage.Error);
                    return;
                }
                ...
                LocalizationManager.ShowMessage($"تم توقيع الوثيقة بنجاح وحفظها في:\n{destinationPath}", LocalizationManager.Translate("نجاح"),
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في توقيع الوثيقة: {ex.Message}", LocalizationManager.Translate("خطأ"),
                    MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
