...
namespace HR_Application.Views
{
    public partial class AddEmployeeDocumentWindow : Window
    {
        ...
        private void SetupFileFilter()
        {
            ...
            string allSupported = "جميع الملفات المدعومة|";
            string images = "الصور|";
        ...
        private void browseBtn_Click(object sender, RoutedEventArgs e)
        {
            if (browseFileDialog.ShowDialog() == true)
            {
                ...
                {
                    MessageBox.Show("نوع الملف غير مدعوم. يرجى اختيار ملف من الأنواع المسموحة.", "تحذير",
        ...
        private async void saveBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show($"تم إضافة الوثيقة بنجاح إلى:\n{destinationPath}", "نجاح",
            ...
            {
                MessageBox.Show($"خطأ في إضافة الوثيقة: {ex.InnerException?.Message ?? ex.Message}", "خطأ",
