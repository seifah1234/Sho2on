...
namespace HR_Application.Views.Employees.Holidays
{
    public partial class EmployeeSelectionWindow : Window
    {
        ...
        public string WindowTitle { get; set; } = LocalizationManager.Translate("اختر موظف");
        public string SelectButtonText { get; set; } = LocalizationManager.Translate("اختيار");
        ...
        private void btnSelect_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("الرجاء اختيار موظف من القائمة", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
            }
        }
    ...
    public class BoolToActiveStatusConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            {
                return isActive ? LocalizationManager.Translate("نشط") : LocalizationManager.Translate("غير نشط");
            }
            return LocalizationManager.Translate("غير معروف");
        }
