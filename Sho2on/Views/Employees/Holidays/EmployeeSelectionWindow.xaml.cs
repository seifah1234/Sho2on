...
namespace HR_Application.Views.Employees.Holidays
{
    public partial class EmployeeSelectionWindow : Window
    {
        ...
        public string WindowTitle { get; set; } = "«Œ — „ÊŸ›";
        public string SelectButtonText { get; set; } = "«Œ Ì«—";

        public string? _searchCode;

        public EmployeeSelectionWindow(List<User> users, bool showManagersOnly = false, string title = "«Œ — „ÊŸ›", string? searchCode = null)
        {
            InitializeComponent();
        ...
        private void btnSelect_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("«·—Ã«¡ «Œ Ì«— „ÊŸ› „‰ «·ﬁ«∆„…", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
        }
