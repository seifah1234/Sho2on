...
namespace HR_Application
{
    ...
    public partial class EmployeeMonthReport : Window
    {
        ...
        public FlowDocument CreateDocument(string year, string month, string branch)
        {
            ...
            // Add title paragraph
            Paragraph titleParagraph = new Paragraph(new Run(" ﬁ—Ì— ”«⁄«  ⁄„· ‘Â—Ì"))
            {
                FontWeight = FontWeights.Bold,
                FontSize = 14,
            ...
            // Add header cells
            dataHeaderRow.Cells.Add(CreateCell("«·ﬂÊœ", true, false));
            dataHeaderRow.Cells.Add(CreateCell("«·«”„", true, true));
            dataHeaderRow.Cells.Add(CreateCell("⁄ «·”«⁄« ", true, false));
            dataHeaderRow.Cells.Add(CreateCell("«· √ŒÌ—", true, false));
            dataHeaderRow.Cells.Add(CreateCell("Œ „»ﬂ—", true, false));
            dataHeaderRow.Cells.Add(CreateCell("«·«÷«›Ì", true, false));
            dataHeaderRow.Cells.Add(CreateCell("” «·›⁄·Ì…", true, false));
            dataHeaderRow.Cells.Add(CreateCell("«·«Ã«“« ", true, false));
            dataHeaderRow.Cells.Add(CreateCell("«·€Ì«»", true, false));
