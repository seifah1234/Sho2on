...
namespace HR_Application
{
    ...
    public partial class EmployeeMonthReport : Window
    {
        ...
        public FlowDocument CreateDocument(string year, string month, string branch)
        {
            ...
            // Add title paragraph
            Paragraph titleParagraph = new Paragraph(new Run(LocalizationManager.Translate("تقرير ساعات عمل شهري")))
            {
                FontWeight = FontWeights.Bold,
                FontSize = 14,
            ...
            // Add header cells
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("الكود"), true, false));
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("الاسم"), true, true));
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("ع الساعات"), true, false));
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("التأخير"), true, false));
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("خ مبكر"), true, false));
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("الاضافي"), true, false));
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("س الفعلية"), true, false));
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("الاجازات"), true, false));
            dataHeaderRow.Cells.Add(CreateCell(LocalizationManager.Translate("الغياب"), true, false));
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    using (var workbook = new XLWorkbook())
                    {
                        ...
                        var headers = new[]
                        {
                            LocalizationManager.Translate("الكود"),
                            LocalizationManager.Translate("الاسم"),
                            LocalizationManager.Translate("س رسمية"),
                            LocalizationManager.Translate("التأخير"),
                            LocalizationManager.Translate("خ مبكر"),
                            LocalizationManager.Translate("الاضافي"),
                            LocalizationManager.Translate("س فعلية"),
                            LocalizationManager.Translate("الاجازات"),
                            LocalizationManager.Translate("الغياب")
                        };
