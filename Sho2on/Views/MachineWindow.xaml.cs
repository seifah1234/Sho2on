...
namespace HR_Application
{
    ...
    public partial class MachineWindow : Window
    {
        ...
        private async Task LoadMachinesAsync()
        {
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في تحميل الأجهزة: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void save_Btn(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("يرجى ملء جميع الحقول", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
                ...
                {
                    LocalizationManager.ShowMessage("الفرع المحدد غير موجود", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
                    return;
                }
                ...
                if (machineExists)
                {
                    LocalizationManager.ShowMessage("هذا الجهاز مضاف مسبقاً لهذا الفرع", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
                ...
                LocalizationManager.ShowMessage("تم إضافة الجهاز بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
                await LoadDataAsync();
            }
            catch (Exception ex)
            {
        ...
        private async void delete_Btn(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("لم يتم اختيار جهاز", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            try
            {
                ...
                if (result == MessageBoxResult.Yes)
                {
                    ...
                    if (machine != null)
                    {
                        ...
                        LocalizationManager.ShowMessage("تم حذف الجهاز بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
                        await LoadDataAsync();
                    }
                }
            }
        ...
        private async void edit_Btn(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (machine != null)
                {
                    ...
                    LocalizationManager.ShowMessage("تم تعديل الجهاز بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
                    await LoadDataAsync();
                }
            }
            catch (Exception ex)
