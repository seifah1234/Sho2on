...
namespace HR_Application
{
    public partial class AddEmplo : Window
    {
        ...
        private void LoadDefaultImage()
        {
            ...
            {
                LocalizationManager.ShowMessage($"Œÿ√ ›Ì  Õ„Ì· «·’Ê—… «·«› —«÷Ì…: {ex.Message}", "Œÿ√", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void Save_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("Â–« «·ﬂÊœ „” Œœ„ »«·›⁄·. «·—Ã«¡ «” Œœ«„ ﬂÊœ „Œ ·›.", " Õ–Ì—",
                ...
                LocalizationManager.ShowMessage(" „ Õ›Ÿ »Ì«‰«  «·„ÊŸ› »‰Ã«Õ", "‰Ã«Õ", MessageBoxButton.OK, MessageBoxImage.Information);
                ClearData();
            }
            catch (DbUpdateException dbEx)
            {
                LocalizationManager.ShowMessage($"Œÿ√ ›Ì ﬁ«⁄œ… «·»Ì«‰« : {dbEx.InnerException?.Message}", "Œÿ√",
        ...
        private async void search_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("·„ Ì „ «·⁄ÀÊ— ⁄·Ï «Ì „ÊŸ›", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                    ClearData();
                }
        ...
        private void FillFormWithUserData(User user)
        {
            ...
            {
                LocalizationManager.ShowMessage($"Œÿ√ ›Ì  Õ„Ì· »Ì«‰«  «·„” Œœ„: {ex.Message}", "Œÿ√", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void edit_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «·»ÕÀ ⁄‰ «·„ÊŸ› √Ê·«", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    await _context.SaveChangesAsync();
                    LocalizationManager.ShowMessage(" „  ⁄œÌ· »Ì«‰«  «·„ÊŸ› »‰Ã«Õ", "‰Ã«Õ", MessageBoxButton.OK, MessageBoxImage.Information);
        ...
        private void ClearData()
        {
            ...
            {
                LocalizationManager.ShowMessage($"Œÿ√ ›Ì „”Õ «·»Ì«‰« : {ex.Message}", "Œÿ√", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private bool ValidateInput()
        {
            ...
            if (string.IsNullOrEmpty(emplo_name_box.Text))
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ ≈œŒ«· «”„ «·„ÊŸ›", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ ≈œŒ«· «·—ﬁ„ «·ﬁÊ„Ì", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«—  «—ÌŒ «·„Ì·«œ", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«—  «—ÌŒ «· ⁄ÌÌ‰", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «·›—⁄", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                branch_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «·≈œ«—…", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                depart_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «·ÊŸÌ›…", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                job_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «·«ﬁ«„…", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                recidenceBox.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «·ﬁÿ«⁄", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                degree_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— ‰Ÿ«„ «·⁄„·", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                job_type_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «·«Ã«“… «·«”»Ê⁄Ì…", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                week_holi_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «·Ê—œÌ…", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                shift_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— «· √„Ì‰", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ ≈œŒ«· ”»» «·≈÷«›… ··ﬁ«∆„… «·”Êœ«¡", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
                blacklist_notes_box.Focus();
                return false;
            }
            ...
            if (!string.IsNullOrEmpty(emplo_email_box.Text))
            {
                try
                {
                    ...
                    {
                        LocalizationManager.ShowMessage("Ì—ÃÏ ≈œŒ«· »—Ìœ ≈·ﬂ —Ê‰Ì ’ÕÌÕ", " Õ–Ì—", MessageBoxButton.OK, MessageBoxImage.Warning);
        ...
        private void OpenArchive_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("Ì—ÃÏ «Œ Ì«— „ÊŸ› √Ê·«", " Õ–Ì—",
                    MessageBoxButton.OK, MessageBoxImage.Warning);
            }
        }
        ...
        private void addImage_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (openFileDialog.ShowDialog() == true)
                {
                    ...
                    {
                        LocalizationManager.ShowMessage("ÕÃ„ «·’Ê—… ﬂ»Ì— Ãœ«. «·—Ã«¡ «Œ Ì«— ’Ê—… √ﬁ· „‰ 5 „ÌÃ«»«Ì .",
        ...
        private void removeImage_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage($"Œÿ√ ›Ì ≈“«·… «·’Ê—…: {ex.Message}", "Œÿ√", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void LoadImageFromFile(string filePath)
        {
            try
            {
                ...
                bitmap.DecodePixelWidth = 200; //  ÕÃÌ„ «·’Ê—… · Õ”Ì‰ «·√œ«¡
                bitmap.EndInit();
        ...
        private void LoadUserImage(byte[] imageData)
        {
            ...
            {
                LocalizationManager.ShowMessage($"Œÿ√ ›Ì  Õ„Ì· ’Ê—… «·„” Œœ„: {ex.Message}", "Œÿ√", MessageBoxButton.OK, MessageBoxImage.Error);
                LoadDefaultImage();
            }
        }
        ...
        private async void Delete_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (LocalizationManager.ShowMessage("Â· √‰  „ √ﬂœ „‰ Õ–› Â–« «·„ÊŸ›ø", " √ﬂÌœ «·Õ–›",
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    await _context.SaveChangesAsync();
                    LocalizationManager.ShowMessage(" „ Õ–› «·„ÊŸ› »‰Ã«Õ", "‰Ã«Õ", MessageBoxButton.OK, MessageBoxImage.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        private void UpdateWindowTitle()
        {
            if (_selectedUser != null)
            {
                this.Title = $" ⁄œÌ· »Ì«‰«  «·„ÊŸ› - {_selectedUser.FullName}";
            }
            else
            {
                this.Title = "≈÷«›… „ÊŸ› ÃœÌœ";
