...
namespace HR_Application
{
    public partial class AddEmplo : Window
    {
        ...
        private void LoadDefaultImage()
        {
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في تحميل الصورة الافتراضية: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void Save_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("هذا الكود مستخدم بالفعل. الرجاء استخدام كود مختلف.", LocalizationManager.Translate("تحذير"),
                ...
                LocalizationManager.ShowMessage("تم حفظ بيانات الموظف بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
                ClearData();
            }
            catch (DbUpdateException dbEx)
            {
                LocalizationManager.ShowMessage($"خطأ في قاعدة البيانات: {dbEx.InnerException?.Message}", LocalizationManager.Translate("خطأ"),
                    MessageBoxButton.OK, MessageBoxImage.Error);
            }
            catch (Exception ex)
            {
                LocalizationManager.ShowMessage($"خطأ في حفظ البيانات: {ex.Message}", LocalizationManager.Translate("خطأ"),
                    MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void search_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("لم يتم العثور على اي موظف", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                    ClearData();
                }
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في البحث: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void FillFormWithUserData(User user)
        {
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في تحميل بيانات المستخدم: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void edit_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("يرجى البحث عن الموظف أولاً", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    await _context.SaveChangesAsync();
                    LocalizationManager.ShowMessage("تم تعديل بيانات الموظف بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في التعديل: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void ClearData()
        {
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في مسح البيانات: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private bool ValidateInput()
        {
            ...
            if (string.IsNullOrEmpty(emplo_name_box.Text))
            {
                LocalizationManager.ShowMessage("يرجى إدخال اسم الموظف", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("يرجى إدخال الرقم القومي", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار تاريخ الميلاد", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار تاريخ التعيين", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار الفرع", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                branch_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار الإدارة", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                depart_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار الوظيفة", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                job_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار الاقامة", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                recidenceBox.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار القطاع", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                degree_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار نظام العمل", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                job_type_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار الاجازة الاسبوعية", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                week_holi_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار الوردية", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                shift_box.Focus();
                return false;
            }
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار التأمين", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
            ...
            {
                LocalizationManager.ShowMessage("يرجى إدخال سبب الإضافة للقائمة السوداء", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
                blacklist_notes_box.Focus();
                return false;
            }
            ...
            if (!string.IsNullOrEmpty(emplo_email_box.Text))
            {
                try
                {
                    ...
                    {
                        LocalizationManager.ShowMessage("يرجى إدخال بريد إلكتروني صحيح", LocalizationManager.Translate("تحذير"), MessageBoxButton.OK, MessageBoxImage.Warning);
        ...
        private void OpenArchive_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("يرجى اختيار موظف أولاً", LocalizationManager.Translate("تحذير"),
                    MessageBoxButton.OK, MessageBoxImage.Warning);
            }
        }
        ...
        private void addImage_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                OpenFileDialog openFileDialog = new OpenFileDialog
                {
                    ...
                    Title = LocalizationManager.Translate("اختر صورة الموظف")
                };
                ...
                if (openFileDialog.ShowDialog() == true)
                {
                    ...
                    {
                        LocalizationManager.ShowMessage("حجم الصورة كبير جداً. الرجاء اختيار صورة أقل من 5 ميجابايت.",
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في تحميل الصورة: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void removeImage_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في إزالة الصورة: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void LoadImageFromFile(string filePath)
        {
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في عرض الصورة: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void LoadUserImage(byte[] imageData)
        {
            ...
            {
                LocalizationManager.ShowMessage($"خطأ في تحميل صورة المستخدم: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
                LoadDefaultImage();
            }
        }
        ...
        private async void Delete_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (LocalizationManager.ShowMessage("هل أنت متأكد من حذف هذا الموظف؟", LocalizationManager.Translate("تأكيد الحذف"),
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    await _context.SaveChangesAsync();
                    LocalizationManager.ShowMessage("تم حذف الموظف بنجاح", LocalizationManager.Translate("نجاح"), MessageBoxButton.OK, MessageBoxImage.Information);
                }
            }
            catch (Exception ex)
            {
                LocalizationManager.ShowMessage($"خطأ في الحذف: {ex.Message}", LocalizationManager.Translate("خطأ"), MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void UpdateWindowTitle()
        {
            ...
            {
                this.Title = LocalizationManager.Translate("إضافة موظف جديد");
            }
        }
