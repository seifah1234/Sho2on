    ...
    public partial class AddDepart : Window
    {
        ...
        private async void save_Btn(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    LocalizationManager.ShowMessage("ÃÏÎá ÇÓã ÇáÅÏÇÑÉ", "ÎØÃ", MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
                ...
                LocalizationManager.ShowMessage("Êã ÅÖÇÝÉ ÇáÅÏÇÑÉ", "", MessageBoxButton.OK, MessageBoxImage.Information);
                LoadData();
            }
            catch
            {
        ...
        private async void delete_Btn(object sender, EventArgs e)
        {
            ...
            {
                LocalizationManager.ShowMessage("áã íÊã ÇÎÊíÇÑ ÇáÅÏÇÑÉ", "ÎØÃ", MessageBoxButton.OK, MessageBoxImage.Error);
                return;
            }
            ...
            try
            {
                ...
                await _context.SaveChangesAsync();
                LocalizationManager.ShowMessage("Êã ÍÐÝ ÇáÅÏÇÑÉ", "", MessageBoxButton.OK, MessageBoxImage.Information);
                LoadData();
            }
            catch
            {
        ...
        private async void edit_Btn(object sender, EventArgs e)
        {
            if (_selectedDepartment == null)
            {
                LocalizationManager.ShowMessage("áã ÊÎÊÇÑ Ãí ÅÏÇÑÉ", "ÎØÃ", MessageBoxButton.OK, MessageBoxImage.Error);
                return;
            }
            ...
            try
            {
                ...
                await _context.SaveChangesAsync();
                LocalizationManager.ShowMessage("Êã ÊÚÏíá ÇáÅÏÇÑÉ", "", MessageBoxButton.OK, MessageBoxImage.Information);
                LoadData();
            }
            catch
            {
