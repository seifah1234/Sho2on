    ...
    public partial class UserBranches : Window
    {
        ...
        private async void saveData()
        {
            try
            {
                ...
                {
                    MessageBox.Show("يرجى اختيار مستخدم أولاً", "تحذير", MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
                ...
                {
                    MessageBox.Show("المستخدم المحدد غير صالح", "خطأ", MessageBoxButton.OK, MessageBoxImage.Error);
                    return;
                }
                ...
                {
                    MessageBox.Show("المستخدم المحدد غير موجود", "خطأ", MessageBoxButton.OK, MessageBoxImage.Error);
                    return;
                }
                ...
                MessageBox.Show("تم تحديث صلاحيات الفروع بنجاح", "نجاح", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
